            ...
            plugins={[
              {
                afterInit: function(chart, options) {
                  let leng = chart.data.labels.length - 1
                  var yLabel = chart.data.datasets[0].data[leng];
                  var xLabel = chart && chart.data && chart.data.labels && chart.data.labels[leng] && chart.data.labels[leng];
